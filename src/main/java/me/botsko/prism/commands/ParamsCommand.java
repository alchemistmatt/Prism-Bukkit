...
public class ParamsCommand implements SubHandler {
    ...
    private void help(CommandSender sender) {
        ...
        sender.sendMessage(Prism.messenger.playerMsg(
              ChatColor.LIGHT_PURPLE + "b:[block]" + ChatColor.WHITE + " Like 'grass' or '2' or '2:0'. No default."));
        sender.sendMessage(Prism.messenger.playerMsg(
              ChatColor.LIGHT_PURPLE + "before:[time]" + ChatColor.WHITE + " Events prior to x long ago."));
        sender.sendMessage(Prism.messenger
              .playerMsg(ChatColor.LIGHT_PURPLE + "e:[entity]" + ChatColor.WHITE + " Like 'pig'. No default."));
        ...
        sender.sendMessage(Prism.messenger
              .playerMsg(ChatColor.LIGHT_PURPLE + "p:[player]" + ChatColor.WHITE + " Like 'viveleroi'. No default."));
        ...
        sender.sendMessage(Prism.messenger.playerMsg(
              ChatColor.LIGHT_PURPLE + "w:[world]" + ChatColor.WHITE + " Defaults to your current world."));
        sender.sendMessage(
              Prism.messenger.playerMsg("Prefix action, player, entity names with ! to exclude. Like p:!viveleroi"));
